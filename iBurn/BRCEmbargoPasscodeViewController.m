...
- (void)viewDidLoad
{
    ...
    self.descriptionLabel.text = @"Camp locations are restricted until the gates open due to BMan regulations. The passcode will be released to the public at 10am on Sunday 8/30.\n\nFollow @iBurnApp on Twitter or Facebook for this year's passcode, or ask a Black Rock Ranger, Playa Info or Burning Man Staffer.";
