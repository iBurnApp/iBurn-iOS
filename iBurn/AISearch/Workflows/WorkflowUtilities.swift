...
//  iBurn
//
//  Shared utilities for AI workflows: context-window/guardrail retry helpers and the
//  camp/art detail-page event-collection summary pipeline (used by DetailViewModel).
//
